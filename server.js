...
const SERVER_REV = "v73 community feed"
...
/** comments.memo_id 가 uuid 일 때: 앱이 보내는 로컬 왕관 id → [memos.id](http://memos.id/)(uuid) 로 치환 */
...
// =========================
// 메모 저장 (local_id = 앱 왕관 [TodoItem.id](http://todoitem.id/), comments FK 용)
// =========================
